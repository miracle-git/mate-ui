...
test('测试：API地址映射(加密)', () => {
  ...
  expect(api.user.list).toEqual('/api/user/list')
  expect(api.product.list).toEqual('/api/product/list')
  expect(window['__MATE_WITH-CRYPTO_API__']).toEqual(
    ''
  )
})
