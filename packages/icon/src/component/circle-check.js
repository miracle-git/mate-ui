...
class MtIconCircleCheck extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconCircleCheck
function install() {
  if (window.customElements.get('mt-icon-circle-check')) return
  window.customElements.define('mt-icon-circle-check', MtIconCircleCheck)
}
