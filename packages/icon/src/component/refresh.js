...
class MtIconRefresh extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconRefresh
function install() {
  if (window.customElements.get('mt-icon-refresh')) return
  window.customElements.define('mt-icon-refresh', MtIconRefresh)
}
