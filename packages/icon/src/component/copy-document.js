...
class MtIconCopyDocument extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconCopyDocument
function install() {
  if (window.customElements.get('mt-icon-copy-document')) return
  window.customElements.define('mt-icon-copy-document', MtIconCopyDocument)
}
