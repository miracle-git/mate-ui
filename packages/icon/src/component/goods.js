...
class MtIconGoods extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconGoods
function install() {
  if (window.customElements.get('mt-icon-goods')) return
  window.customElements.define('mt-icon-goods', MtIconGoods)
}
