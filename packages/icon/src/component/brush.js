...
class MtIconBrush extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconBrush
function install() {
  if (window.customElements.get('mt-icon-brush')) return
  window.customElements.define('mt-icon-brush', MtIconBrush)
}
