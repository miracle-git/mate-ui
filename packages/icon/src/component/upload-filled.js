...
class MtIconUploadFilled extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconUploadFilled
function install() {
  if (window.customElements.get('mt-icon-upload-filled')) return
  window.customElements.define('mt-icon-upload-filled', MtIconUploadFilled)
}
