...
class MtIconLocationInformation extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconLocationInformation
function install() {
  if (window.customElements.get('mt-icon-location-information')) return
  window.customElements.define('mt-icon-location-information', MtIconLocationInformation)
}
