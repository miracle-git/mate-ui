...
class MtIconMilkTea extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconMilkTea
function install() {
  if (window.customElements.get('mt-icon-milk-tea')) return
  window.customElements.define('mt-icon-milk-tea', MtIconMilkTea)
}
