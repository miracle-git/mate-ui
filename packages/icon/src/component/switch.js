...
class MtIconSwitch extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconSwitch
function install() {
  if (window.customElements.get('mt-icon-switch')) return
  window.customElements.define('mt-icon-switch', MtIconSwitch)
}
