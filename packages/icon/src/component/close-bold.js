...
class MtIconCloseBold extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconCloseBold
function install() {
  if (window.customElements.get('mt-icon-close-bold')) return
  window.customElements.define('mt-icon-close-bold', MtIconCloseBold)
}
