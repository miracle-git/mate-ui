...
class MtIconArrowRight extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconArrowRight
function install() {
  if (window.customElements.get('mt-icon-arrow-right')) return
  window.customElements.define('mt-icon-arrow-right', MtIconArrowRight)
}
