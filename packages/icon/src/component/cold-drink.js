...
class MtIconColdDrink extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconColdDrink
function install() {
  if (window.customElements.get('mt-icon-cold-drink')) return
  window.customElements.define('mt-icon-cold-drink', MtIconColdDrink)
}
