...
class MtIconIceCreamRound extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconIceCreamRound
function install() {
  if (window.customElements.get('mt-icon-ice-cream-round')) return
  window.customElements.define('mt-icon-ice-cream-round', MtIconIceCreamRound)
}
