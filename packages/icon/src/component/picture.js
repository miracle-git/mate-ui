...
class MtIconPicture extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconPicture
function install() {
  if (window.customElements.get('mt-icon-picture')) return
  window.customElements.define('mt-icon-picture', MtIconPicture)
}
