...
class MtIconPhone extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconPhone
function install() {
  if (window.customElements.get('mt-icon-phone')) return
  window.customElements.define('mt-icon-phone', MtIconPhone)
}
