...
class MtIconFood extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconFood
function install() {
  if (window.customElements.get('mt-icon-food')) return
  window.customElements.define('mt-icon-food', MtIconFood)
}
