...
class MtIconCoffee extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconCoffee
function install() {
  if (window.customElements.get('mt-icon-coffee')) return
  window.customElements.define('mt-icon-coffee', MtIconCoffee)
}
