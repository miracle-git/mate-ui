...
class MtIconDocumentChecked extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconDocumentChecked
function install() {
  if (window.customElements.get('mt-icon-document-checked')) return
  window.customElements.define('mt-icon-document-checked', MtIconDocumentChecked)
}
