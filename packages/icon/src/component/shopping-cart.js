...
class MtIconShoppingCart extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconShoppingCart
function install() {
  if (window.customElements.get('mt-icon-shopping-cart')) return
  window.customElements.define('mt-icon-shopping-cart', MtIconShoppingCart)
}
