...
class MtIconLock extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconLock
function install() {
  if (window.customElements.get('mt-icon-lock')) return
  window.customElements.define('mt-icon-lock', MtIconLock)
}
