...
class MtIconScissor extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconScissor
function install() {
  if (window.customElements.get('mt-icon-scissor')) return
  window.customElements.define('mt-icon-scissor', MtIconScissor)
}
