...
class MtIconSuccessFilled extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconSuccessFilled
function install() {
  if (window.customElements.get('mt-icon-success-filled')) return
  window.customElements.define('mt-icon-success-filled', MtIconSuccessFilled)
}
