...
class MtIconSell extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconSell
function install() {
  if (window.customElements.get('mt-icon-sell')) return
  window.customElements.define('mt-icon-sell', MtIconSell)
}
