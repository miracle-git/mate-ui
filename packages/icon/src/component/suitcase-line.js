...
class MtIconSuitcaseLine extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconSuitcaseLine
function install() {
  if (window.customElements.get('mt-icon-suitcase-line')) return
  window.customElements.define('mt-icon-suitcase-line', MtIconSuitcaseLine)
}
