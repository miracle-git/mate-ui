...
class MtIconCircleCheckFilled extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconCircleCheckFilled
function install() {
  if (window.customElements.get('mt-icon-circle-check-filled')) return
  window.customElements.define('mt-icon-circle-check-filled', MtIconCircleCheckFilled)
}
