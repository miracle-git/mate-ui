...
class MtIconLink extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconLink
function install() {
  if (window.customElements.get('mt-icon-link')) return
  window.customElements.define('mt-icon-link', MtIconLink)
}
