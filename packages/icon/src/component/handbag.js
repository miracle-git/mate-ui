...
class MtIconHandbag extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconHandbag
function install() {
  if (window.customElements.get('mt-icon-handbag')) return
  window.customElements.define('mt-icon-handbag', MtIconHandbag)
}
