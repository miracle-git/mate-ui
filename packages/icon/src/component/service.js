...
class MtIconService extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconService
function install() {
  if (window.customElements.get('mt-icon-service')) return
  window.customElements.define('mt-icon-service', MtIconService)
}
