...
class MtIconAddLocation extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconAddLocation
function install() {
  if (window.customElements.get('mt-icon-add-location')) return
  window.customElements.define('mt-icon-add-location', MtIconAddLocation)
}
