...
class MtIconInfoFilled extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconInfoFilled
function install() {
  if (window.customElements.get('mt-icon-info-filled')) return
  window.customElements.define('mt-icon-info-filled', MtIconInfoFilled)
}
