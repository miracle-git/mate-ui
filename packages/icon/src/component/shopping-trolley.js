...
class MtIconShoppingTrolley extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconShoppingTrolley
function install() {
  if (window.customElements.get('mt-icon-shopping-trolley')) return
  window.customElements.define('mt-icon-shopping-trolley', MtIconShoppingTrolley)
}
