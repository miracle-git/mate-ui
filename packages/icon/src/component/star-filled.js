...
class MtIconStarFilled extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconStarFilled
function install() {
  if (window.customElements.get('mt-icon-star-filled')) return
  window.customElements.define('mt-icon-star-filled', MtIconStarFilled)
}
