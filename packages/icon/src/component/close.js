...
class MtIconClose extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconClose
function install() {
  if (window.customElements.get('mt-icon-close')) return
  window.customElements.define('mt-icon-close', MtIconClose)
}
