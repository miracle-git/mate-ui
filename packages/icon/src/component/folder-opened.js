...
class MtIconFolderOpened extends MtIconElement {
  constructor() {
    super(`
...
export default MtIconFolderOpened
function install() {
  if (window.customElements.get('mt-icon-folder-opened')) return
  window.customElements.define('mt-icon-folder-opened', MtIconFolderOpened)
}
